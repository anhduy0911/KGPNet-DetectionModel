...
def main():
    ...
    #     shutil.copy(s_path + '/pics/' + image_id + '.jpg', os.path.join(datasets_path, "base_train", "images", image_id + ".jpg"))
    ...
    #     shutil.copy(s_path + '/pics/' + image_id + '.jpg', os.path.join(datasets_path, "base_test", "images", image_id + ".jpg"))
    ...
    for image_id in list(set(train_files)):
        shutil.copy(s_path + '/pics/' + image_id + '.jpg', os.path.join(datasets_path, "all_train", "images", image_id + ".jpg"))
        shutil.copy(s_path + '/json/' + image_id + '.json', os.path.join(datasets_path, "all_train", "labels", image_id + ".json"))
    for image_id in list(set(test_files)):
        shutil.copy(s_path + '/pics/' + image_id + '.jpg', os.path.join(datasets_path, "all_test", "images", image_id + ".jpg"))
